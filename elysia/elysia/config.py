...
# Try to load from Ansible Vault first, fallback to .env
try:
    from elysia.api.utils.vault_loader import setup_vault_env
    setup_vault_env()
    print("✓ Loaded secrets from Ansible Vault")
except Exception as e:
    print(f"! Vault loading failed ({e}), falling back to .env file")
